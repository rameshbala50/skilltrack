...
<body class="app-body">
  ...
  <aside class="sidebar" id="sidebar" role="navigation" aria-label="Main navigation">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item" data-panel="jobsummary" onclick="switchPanel('jobsummary', this)">
  ...
  <div class="app-main">
    ...
    <main class="app-content" id="app-content-main" role="main">
      ...
      <!-- ── Job Summary ────────────────────────────────────── -->
      <section class="panel" id="panel-jobsummary">
        <div class="panel-header">
          <h1 class="panel-title">Job Summary</h1>
          <p class="panel-subtitle">Overview of all tracked jobs — click any row to open Job Tracker with that filter</p>
        </div>
  ...
  <script src="js/jobsummary.js?v=<?php echo $v; ?>"></script>
  <script src="js/jobalts.js?v=<?php echo $v; ?>"></script>
